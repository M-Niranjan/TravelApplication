    ...
    <body>
      <div class="header">
        <div class="brand">
          ...
          <div>
            <div class="brand-name">Voyager Luxe</div>
            <div class="brand-sub">Intelligent Luxury Travel</div>
          </div>
        </div>
      ...
      <div class="print-footer">
        <div class="print-footer-left">Generated by <strong>Voyager Luxe</strong> · Intelligent Itinerary Planner</div>
